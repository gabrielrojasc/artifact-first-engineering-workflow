...
- Keep Markdown as the source of truth and regenerate the HTML sibling with `scripts/render-artifact.sh` whenever you update the status or mismatch artifact; never hand-edit the generated HTML.
